...
#ifndef H_workM_teste_H
#define H_workM_teste_H
...
class workM_teste : public HSim__s5{
public: 
    workM_teste(const char *instname);
    ~workM_teste();
    void setDefparam();
