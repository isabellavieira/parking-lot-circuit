...
#ifndef H_workM_decodificador_H
#define H_workM_decodificador_H
...
class workM_decodificador : public HSim__s5{
public: 
    workM_decodificador(const char *instname);
    ~workM_decodificador();
    void setDefparam();
