...
#ifndef H_workM_multiplexador_H
#define H_workM_multiplexador_H
...
class workM_multiplexador : public HSim__s5{
public: 
    workM_multiplexador(const char *instname);
    ~workM_multiplexador();
    void setDefparam();
